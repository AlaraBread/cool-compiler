...
class Main inherits Util {
	main(): Object {
		let input_list : StringList <- let l: StringList <- new StringList in {
			l.append("El Cid conquers Valencia");
			l.append("11th century begins");
			l.append("Knights Templar founded");
			l.append("12th century begins");
			l.append("Bantu-speaking peoples arrive in Angola");
			l.append("13th century begins");
			l.append("Macbeth succeeds Duncan 1 of Scotland ");
			l.append("11th century begins");
			l.append("Song dynasty loses power in Nortern China");
			l.append("12th century begins");
			l.append("Uri, Schwyz, and Unterwalden form Swiss Confederation ");
			l.append("13th century begins");
			l.append("-");
			l.append("--");
			l.append("12th century begins");
			l.append("11th century ends");
			l.append("13th century begins");
			l.append("12th century ends");
			l.append("--");
			l.append("---");
			l.append("11th century ends");
			l.append("11th century begins");
